...
gulp.task('default', ['watch', 'replace', 'minify-main', 'minify-controllers', 'minify-services', 'minify-directives', 'minify-css']);
gulp.task('deploy', ['replace', 'minify-main', 'minify-controllers', 'minify-services', 'minify-directives', 'minify-css']);
...
gulp.task('watch', function () {
	...
	gulp.watch('client/js/directives/*.js', ['replace', 'minify-directives']);
